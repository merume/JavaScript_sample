(function($) {
  $.widget("sample.hello", {
    ...
    _create: function() {
      ...
      self.element.addClass("demo-hello").text("Hello " + originalText + "!");
      self.element.on(self.options.event, self._eventCallback);
    },
    destory: function() {
      self.element.removeClass("demo-hello").removeAttr('style').text(originalText);
    ...
    _eventCallback: function(eventObject) {
      self.element.animate(
        {color: "white", backgroundColor: "Orange"}, function(){
